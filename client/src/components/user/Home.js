...
import scholarshipImage from '../../../../client/src/images/scholarshipimage.png'
        ...
        <div className="container">
          <div className="grid-cols-2">
            <div className="grid-item-1" data-aos="fade-up" data-aos-duration="800">
              ...
              Welcome to <span>Scholarship Scout!</span>
                <br />
              </h1>
            ...
            <div className="grid-item-2" data-aos="fade-up" data-aos-duration="1000">
              <div className="team_img_wrapper">
                <img src={scholarshipImage} alt="Scholarshipimage"/>
              </div>
            </div>
          </div>
        </div>
