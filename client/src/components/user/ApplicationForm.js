...
const ApplicationForm = () => {
  ...
  const [referral1_email, setreferral1_email] = useState("");
  const [referral2_email, setreferral2_email] = useState("");
                ...
                <Container>
                  ...
                  <div className="form-group  ">
                    <Row>
                      <Col xs={12} sm={12} md={2}>
                        <label className=" col-form-label">
                           Referee Email<span className="compulsory">*</span>
                        </label>
                      </Col>
                      <Col xs={12} sm={12} md={4}>
                        <div className="   ">
                          <input
                            ...
                            className="form-control"
                            type="text"
                            placeholder="Enter email id of referee"
                            required
                            value={referral1_email}
                            onChange={(e) => setreferral1_email(e.target.value)}
                          />
                        </div>
                      </Col>
                      <Col xs={12} sm={12} md={2}>
                        <label className=" col-form-label">
                        Letter of Recommendation<span className="compulsory">*</span>
                        </label>
                      </Col>
                      <Col xs={12} sm={12} md={4}>
                        <div className="   ">
                          <input
                            ...
                            className="form-control"
                            type="file"
                            placeholder="Attach first Letter of Recommendation"
                            value={referral1}
                  ...
                  <div className="form-group  ">
                    <Row>
                      <Col xs={12} sm={12} md={2}>
                        <label className=" col-form-label">
                           Another Referee Email<span className="compulsory">*</span>
                        </label>
                      </Col>
                      <Col xs={12} sm={12} md={4}>
                        <div className="   ">
                          <input
                            ...
                            className="form-control"
                            type="text"
                            placeholder="Enter email id of another referee"
                            required
                            value={referral2_email}
                            onChange={(e) => setreferral2_email(e.target.value)}
                          />
                        </div>
                      </Col>
                      <Col xs={12} sm={12} md={2}>
                      ...
                      <Col xs={12} sm={12} md={4}>
                        <div className="   ">
                          <input
                            ...
                            className="form-control"
                            type="file"
                            placeholder="Attach another Letter of Recommendation"
                            value={referral2}
                      ...
                      <Col xs={12} sm={12} md={4}>
                        <div className="">
                          <input
                            ...
                            type="file"
                            multiple
                            placeholder="Attach Cerfiticates (if any)"
                            value={certificates}
